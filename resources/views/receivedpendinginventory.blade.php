...
@section('content')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="approvemobile" action="{{ route('approve') }}" method="post"
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="restoremobile" action="{{ route('receivedPendingRestore') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-body">
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control" id="rmobile_name" name="mobile_name"
                                    disabled>
                            </div>
                            ...
                            <div class="mb-1">
                                <label for="selling_price" class="form-label">Selling Price</label>
                                <input type="number" class="form-control" id="rselling_price" name="selling_price"
                                    required>
                            </div>
                ...
                <div class="modal-body">
                    <form class="form" id="restoremobile" action="{{ route('moveToOwner') }}" method="post"
                        ...
                        <div class="form-body">
                            ...
                            {{-- <div class="mb-1">
                                <label for="battery_health" class="form-label">Owner Name</label>
                                <input type="text" class="form-control" id="ooriginal_owner_id" name="original_owner_id"
                                    readonly>
                            </div> --}}
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-12 latest-update-tracking mt-1">
                    <div class="card">
                        <div class="card-header latest-update-heading d-flex justify-content-between">
                            <h4 class="latest-update-heading-title text-bold-500">Received Pending Mobiles</h4>
    ...
    @endif
                                            ...
                                            <td>
                                                <a href="#" onclick="restore({{ $key->id }})"
                                                    data-toggle="modal" data-target="#exampleModal2">

                                                    <span
                                                        class="badge badge-primary">{{ $key->availability }}</span>
                                                </a>
                                            </td>
        ...
        function restore(value) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#ravailability').val(data.result.availability);
                },
                error: function(error) {
                    console.log('Error:', error);
                }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#oid').val(data.result.id);
                                                     $('#omobile_name').val(data.result.mobile_name_display || '');
