...
@section('content')
    ...
    <div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel2">Move to Inventory</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-12 latest-update-tracking mt-1">
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered zero-configuration" id="recentTable">
                                    <thead>
                                        <tr>
                                            <th>Transfer Date</th>
                                            <th>Mobile Name</th>
    ...
    <script>
       //Genrate PDF
         ...
         document.getElementById("exportPDF").addEventListener("click", function() {
            var tableContent = document.getElementById("recentTable").outerHTML;
